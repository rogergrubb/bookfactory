...
export const TOOL_CATEGORIES: { id: ToolCategory; label: string; description: string; color: string }[] = [
  { id: 'generate', label: 'Generate', description: 'Create new content', color: 'teal' },
  { id: 'enhance', label: 'Enhance', description: 'Improve existing content', color: 'violet' },
  { id: 'analyze', label: 'Analyze', description: 'Evaluate and measure', color: 'blue' },
  { id: 'brainstorm', label: 'Brainstorm', description: 'Generate ideas', color: 'amber' },
