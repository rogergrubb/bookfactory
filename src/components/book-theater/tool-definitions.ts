import {
  ...
  Maximize2, Minimize2, Sparkles, Dumbbell, Waves, MessageCircle, Eye,
...
export const tools: Tool[] = [
  // GENERATE (12)
  { id: 'continue', name: 'Continue Writing', shortName: 'Cont', icon: Play, category: 'generate', description: 'Continue the story from where you left off', hasSubMenu: true, subOptions: [
    { id: 'auto', name: 'Auto-continue', description: 'Let AI decide direction' },
    ...
    { id: 'chapter-end', name: 'Write to Chapter End', description: 'Continue until chapter break' },
  ]},
  { id: 'firstdraft', name: 'First Draft', shortName: 'Draft', icon: Zap, category: 'generate', description: 'Generate a quick first draft', hasSubMenu: true, subOptions: [
    { id: 'from-outline', name: 'From Outline', description: 'Expand bullet points' },
    { id: 'from-summary', name: 'From Summary', description: 'Expand summary to scene' },
    { id: 'from-beats', name: 'From Scene Beats', description: 'Convert beats to narrative' },
    { id: 'freewrite', name: 'Freewrite Mode', description: 'Just get words down' },
  ]},
  { id: 'dialogue', name: 'Write Dialogue', shortName: 'Dial', icon: MessageSquare, category: 'generate', description: 'Generate character dialogue', isDynamic: true, dynamicSource: 'characters', hasSubMenu: true, subOptions: [
  ...
  { id: 'description', name: 'Add Description', shortName: 'Desc', icon: Palette, category: 'generate', description: 'Add rich sensory details', hasSubMenu: true, subOptions: [
    ...
    { id: 'sensory-full', name: 'Full Sensory (5 senses)', description: 'All five senses' },
  ...
  { id: 'action', name: 'Action Scene', shortName: 'Actn', icon: Swords, category: 'generate', description: 'Write intense action sequences', hasSubMenu: true, subOptions: [
    { id: 'fight-melee', name: 'Melee Combat', description: 'Close quarters fighting' },
    { id: 'fight-ranged', name: 'Ranged Combat', description: 'Guns, bows, magic' },
  ...
  { id: 'thoughts', name: 'Inner Thoughts', shortName: 'Mind', icon: Brain, category: 'generate', description: 'Write internal monologue', isDynamic: true, dynamicSource: 'characters', hasSubMenu: true, subOptions: [
    { id: 'reflection', name: 'Reflection', description: 'Thinking about past' },
    ...
    { id: 'judgment', name: 'Judgment/Assessment', description: 'Evaluating situations' },
  ]},
  { id: 'opening', name: 'Opening Hook', shortName: 'Hook', icon: Anchor, category: 'generate', description: 'Write compelling opening lines', hasSubMenu: true, subOptions: [
    { id: 'action-hook', name: 'Action Opening', description: 'Start with action' },
  ...
  { id: 'ending', name: 'Chapter Ending', shortName: 'End', icon: Target, category: 'generate', description: 'Write chapter endings', hasSubMenu: true, subOptions: [
    { id: 'cliffhanger', name: 'Cliffhanger', description: 'Leave them hanging' },
    { id: 'revelation', name: 'Revelation', description: 'End with discovery' },
  ...
  { id: 'transition', name: 'Write Transition', shortName: 'Trans', icon: ArrowRightLeft, category: 'generate', description: 'Bridge scenes or time periods', hasSubMenu: true, subOptions: [
  ...
  { id: 'flashback', name: 'Flashback/Memory', shortName: 'Flash', icon: History, category: 'generate', description: 'Write flashback sequences', hasSubMenu: true, subOptions: [
  ...
  { id: 'monologue', name: 'Monologue/Speech', shortName: 'Mono', icon: Mic, category: 'generate', description: 'Write speeches or monologues', hasSubMenu: true, subOptions: [
  ...
  { id: 'letter', name: 'Letter/Document', shortName: 'Letr', icon: Mail, category: 'generate', description: 'Write in-world documents', hasSubMenu: true, subOptions: [
  ...
  // ENHANCE (14)
  { id: 'expand', name: 'Expand', shortName: 'Exp', icon: Maximize2, category: 'enhance', description: 'Expand selected text with more detail', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'condense', name: 'Condense', shortName: 'Cond', icon: Minimize2, category: 'enhance', description: 'Tighten and condense text', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'rewrite', name: 'Rewrite', shortName: 'Rew', icon: RefreshCw, category: 'enhance', description: 'Rewrite in a different style', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'polish', name: 'Polish Prose', shortName: 'Pol', icon: Sparkles, category: 'enhance', description: 'Polish for better flow', requiresSelection: true, hasSubMenu: true, subOptions: [
    ...
    { id: 'rhythm', name: 'Improve Rhythm', description: 'Better cadence' },
    { id: 'clarity', name: 'Improve Clarity', description: 'Clearer meaning' },
    { id: 'full-polish', name: 'Full Polish', description: 'All of the above' },
  ]},
  { id: 'strengthen-verbs', name: 'Strengthen Verbs', shortName: 'Verb', icon: Dumbbell, category: 'enhance', description: 'Replace weak verbs', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'vary-sentences', name: 'Vary Sentences', shortName: 'Vary', icon: Waves, category: 'enhance', description: 'Improve sentence variety', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'fix-dialogue-tags', name: 'Fix Dialogue Tags', shortName: 'Tags', icon: MessageCircle, category: 'enhance', description: 'Improve dialogue attribution', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'show-dont-tell', name: "Show Don't Tell", shortName: 'Show', icon: Eye, category: 'enhance', description: 'Convert telling into showing', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'add-conflict', name: 'Add Conflict', shortName: 'Conf', icon: Flame, category: 'enhance', description: 'Inject tension and conflict', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'add-subtext', name: 'Add Subtext', shortName: 'Sub', icon: Layers, category: 'enhance', description: 'Layer meaning beneath surface', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'adjust-pov', name: 'Adjust POV', shortName: 'POV', icon: Glasses, category: 'enhance', description: 'Refine point of view', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'adjust-tense', name: 'Adjust Tense', shortName: 'Tense', icon: Clock, category: 'enhance', description: 'Fix or change verb tense', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'punch-up', name: 'Punch Up', shortName: 'Punch', icon: Star, category: 'enhance', description: 'Make prose more impactful', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'smooth-transitions', name: 'Smooth Transitions', shortName: 'Smth', icon: Wind, category: 'enhance', description: 'Improve flow between sections', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  // ANALYZE (14)
  { id: 'pacing', name: 'Pacing Analysis', shortName: 'Pace', icon: BarChart3, category: 'analyze', description: 'Analyze pacing and tension flow', hasSubMenu: true, subOptions: [
  ...
  { id: 'voice-check', name: 'Voice Consistency', shortName: 'Voice', icon: Mic, category: 'analyze', description: 'Check narrative voice consistency', hasSubMenu: true, subOptions: [
  ...
  { id: 'tension-map', name: 'Tension Map', shortName: 'Tens', icon: TrendingUp, category: 'analyze', description: 'Map tension levels', hasSubMenu: true, subOptions: [
  ...
  { id: 'character-voice', name: 'Character Voice Analysis', shortName: 'ChrV', icon: Users, category: 'analyze', description: 'Analyze character voice distinctiveness', isDynamic: true, dynamicSource: 'characters', hasSubMenu: true, subOptions: [
  ...
  { id: 'repetition', name: 'Repetition Finder', shortName: 'Rep', icon: RefreshCw, category: 'analyze', description: 'Find repeated words and phrases', hasSubMenu: true, subOptions: [
  ...
  { id: 'adverb-hunter', name: 'Adverb Hunter', shortName: 'Adv', icon: Search, category: 'analyze', description: 'Identify overused adverbs', hasSubMenu: true, subOptions: [
  ...
  { id: 'passive-voice', name: 'Passive Voice Finder', shortName: 'Pass', icon: Volume2, category: 'analyze', description: 'Find passive voice constructions', hasSubMenu: true, subOptions: [
  ...
  { id: 'readability', name: 'Readability Score', shortName: 'Read', icon: Gauge, category: 'analyze', description: 'Assess reading level', hasSubMenu: true, subOptions: [
  ...
  { id: 'emotional-arc', name: 'Emotional Arc', shortName: 'Emo', icon: Heart, category: 'analyze', description: 'Track emotional journey', hasSubMenu: true, subOptions: [
  ...
  { id: 'chapter-summary', name: 'Chapter Summary', shortName: 'Sum', icon: FileText, category: 'analyze', description: 'Generate chapter summary', hasSubMenu: true, subOptions: [
  ...
  { id: 'plot-holes', name: 'Plot Hole Finder', shortName: 'Hole', icon: AlertTriangle, category: 'analyze', description: 'Find plot inconsistencies', hasSubMenu: true, subOptions: [
    ...
    { id: 'logic', name: 'Logic Gaps', description: 'Things that dont add up' },
    { id: 'all', name: 'Full Analysis', description: 'All potential issues' },
  ]},
  { id: 'dialogue-analysis', name: 'Dialogue Analysis', shortName: 'DiaA', icon: MessagesSquare, category: 'analyze', description: 'Analyze dialogue quality', hasSubMenu: true, subOptions: [
  ...
  { id: 'show-tell-ratio', name: 'Show/Tell Ratio', shortName: 'S/T', icon: Scale, category: 'analyze', description: 'Analyze showing vs telling', hasSubMenu: true, subOptions: [
  ...
  { id: 'cliche-finder', name: 'Cliché Finder', shortName: 'Clic', icon: Copy, category: 'analyze', description: 'Find clichés and overused phrases', hasSubMenu: true, subOptions: [
  ...
  { id: 'character-moments', name: 'Character Moments', shortName: 'Char', icon: UserPlus, category: 'brainstorm', description: 'Generate character moments', isDynamic: true, dynamicSource: 'characters', hasSubMenu: true, subOptions: [
  ...
  { id: 'dialogue-options', name: 'Dialogue Options', shortName: 'DiaO', icon: MessagesSquare, category: 'brainstorm', description: 'Generate dialogue alternatives', requiresSelection: true, hasSubMenu: true, subOptions: [
  ...
  { id: 'scene-transitions', name: 'Scene Transitions', shortName: 'Trans', icon: ArrowRightLeft, category: 'brainstorm', description: 'Suggest transition approaches', hasSubMenu: true, subOptions: [
  ...
  { id: 'conflict-escalation', name: 'Conflict Escalation', shortName: 'Escl', icon: Flame, category: 'brainstorm', description: 'Escalate conflict and tension', hasSubMenu: true, subOptions: [
  ...
  { id: 'twist-generator', name: 'Twist Generator', shortName: 'Twist', icon: Shuffle, category: 'brainstorm', description: 'Generate plot twists', hasSubMenu: true, subOptions: [
    ...
    { id: 'reality', name: 'Reality Twist', description: 'World isnt what it seems' },
  ]},
  { id: 'what-if', name: 'What If...', shortName: 'What', icon: HelpCircle, category: 'brainstorm', description: 'Explore what-if scenarios', hasSubMenu: true, subOptions: [
  ...
  { id: 'stuck-help', name: "I'm Stuck", shortName: 'Stuck', icon: HelpCircle, category: 'brainstorm', description: 'Get help when stuck', hasSubMenu: true, subOptions: [
    { id: 'diagnose', name: 'Diagnose Problem', description: 'Whats blocking you?' },
  ...
  { id: 'names-generator', name: 'Name Generator', shortName: 'Name', icon: Tag, category: 'brainstorm', description: 'Generate names', hasSubMenu: true, subOptions: [
  ...
  { id: 'motivation-finder', name: 'Motivation Finder', shortName: 'Motiv', icon: Target, category: 'brainstorm', description: 'Develop character motivations', isDynamic: true, dynamicSource: 'characters', hasSubMenu: true, subOptions: [
  ...
  { id: 'theme-explorer', name: 'Theme Explorer', shortName: 'Theme', icon: Compass, category: 'brainstorm', description: 'Explore and develop themes', hasSubMenu: true, subOptions: [
  ...
  { id: 'ending-ideas', name: 'Ending Ideas', shortName: 'Ends', icon: Target, category: 'brainstorm', description: 'Generate possible endings', hasSubMenu: true, subOptions: [
  ...
  { id: 'locations', name: 'Locations', shortName: 'Loc', icon: Globe, category: 'world', description: 'Manage story locations', hasSubMenu: true, subOptions: [
  ...
  { id: 'plot-threads', name: 'Plot Threads', shortName: 'Thrd', icon: GitBranch, category: 'world', description: 'Track plot threads and subplots', hasSubMenu: true, subOptions: [
  ...
  { id: 'timeline', name: 'Timeline', shortName: 'Time', icon: Clock, category: 'world', description: 'Story timeline and events', hasSubMenu: true, subOptions: [
  ...
  { id: 'scene-contexts', name: 'Scene Contexts', shortName: 'Scene', icon: Layers, category: 'world', description: 'Create sensory palettes', hasSubMenu: true, subOptions: [
  ...
  { id: 'story-bible', name: 'Story Bible', shortName: 'Bible', icon: BookMarked, category: 'world', description: 'Complete story reference', hasSubMenu: true, subOptions: [
  ...
  { id: 'magic-system', name: 'Magic/Tech System', shortName: 'Magic', icon: Wand2, category: 'world', description: 'Define supernatural or tech rules', hasSubMenu: true, subOptions: [
  ...
  { id: 'factions', name: 'Factions/Groups', shortName: 'Fact', icon: Shield, category: 'world', description: 'Organizations and groups', hasSubMenu: true, subOptions: [
    ...
    { id: 'hierarchy', name: 'Power Structure', description: 'Whos in charge' },
  ]},
  { id: 'items', name: 'Important Items', shortName: 'Item', icon: Gem, category: 'world', description: 'Track significant objects', hasSubMenu: true, subOptions: [
  ...
  { id: 'research', name: 'Research Notes', shortName: 'Rsch', icon: BookOpen, category: 'world', description: 'Store research and references', hasSubMenu: true, subOptions: [
